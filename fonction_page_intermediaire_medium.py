...
def page_intermediaire_medium():
    ...
    img_fond_intermediaire = pygame.image.load("img/alien_intermediaire_medium.jpg").convert()
    img_fond_intermediaire = pygame. transform.scale(img_fond_intermediaire, (width_page_intermediaire, height_page_intermediaire))

    click_sound = pygame.mixer.Sound("effet sonore/Shot star Wars Blaster.ogg")
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if button_commencer_jeu_rect.collidepoint(mouse_pos):
                    print(f"Commencer le jeu : Niveau Medium")
                    click_sound.play()
